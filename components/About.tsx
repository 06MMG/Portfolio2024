  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1240px] mx-auto px-6 md:px-8 lg:px-12 py-8 md:py-12 flex flex-col md:flex-row items-center space-y-12 md:space-y-0 md:space-x-16">
        ...
        {/* Right: Text Section */}
        <div className="w-full md:w-1/2 text-white space-y-6 md:space-y-8 relative z-20 bg-[#4A00E0] md:bg-transparent p-6 md:p-0 rounded-lg md:rounded-none">
          <p className="uppercase text-lg tracking-wider text-[#FFD700] animate-fade-in">
            Let's Collaborate
          </p>
          <h2 className="text-3xl md:text-4xl font-bold animate-slide-left leading-tight">
